...
Thank you for your interest in contributing to Llamaswarm! This document provides guidelines and instructions for contributing to this project.
...
2. **Clone your fork**:
   ```bash
   git clone https://github.com/YOUR_USERNAME/LlamaSwarm.git
   cd LlamaSwarm
   ```

3. **Set up the upstream remote**:
   ```bash
   git remote add upstream https://github.com/llamasearchai/LlamaSwarm.git
   ```
...
By contributing to Llamaswarm, you agree that your contributions will be licensed under the project's MIT License.
