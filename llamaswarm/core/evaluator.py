...
class Evaluator:
    ...
    def evaluate(self, save_trajectories=False):
        ...
        for episode in tqdm(range(self.n_episodes)):
            episode_rewards, episode_length, trajectory = self._evaluate_episode(save_trajectories)
    ...
    def _save_results(self):
        ...
        metrics_copy = {k: v for k, v in self.eval_metrics.items() if k != 'trajectories'}
