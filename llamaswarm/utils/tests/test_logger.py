...
class TestLogger(unittest.TestCase):
    ...
    def test_log_dict(self):
        ...
        metrics_dict = {"metric1": 1.0, "metric2": 2.0, "metric3": 3.0}
    ...
    def test_log_episode_summary(self):
        ...
        episode_steps = 100
        episode_metrics = {"loss": 0.5, "value_loss": 0.3, "policy_loss": 0.2}
        ...
        # Check values
        self.assertEqual(
            self.logger.metrics["episode_reward"][0]["value"], sum(episode_rewards)
        )
