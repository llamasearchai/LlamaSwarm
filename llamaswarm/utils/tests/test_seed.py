...
from llamaswarm.utils.seed import get_random_seed, set_seed
...
class TestSeed(unittest.TestCase):
    ...
    def test_set_seed_reproducibility(self):
        ...
        torch.testing.assert_close(
            torch.tensor(torch_values1), torch.tensor(torch_values2)
        )
    ...
    def test_different_seeds_different_results(self):
        ...
        self.assertFalse(
            torch.allclose(torch.tensor(torch_values1), torch.tensor(torch_values2))
        )
    ...
    def test_all_seed_functions_called(
        self, mock_torch_seed, mock_np_seed, mock_random_seed
    ):
