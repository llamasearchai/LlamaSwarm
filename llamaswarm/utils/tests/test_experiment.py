...
class TestExperimentManager(unittest.TestCase):
    ...
    def test_load_config_json(self):
        ...
        config_data = {"algorithm": "PPO", "environment": "GridWorld", "num_agents": 5}
    ...
    def test_update_config(self):
        ...
        # Update config
        update_data = {"learning_rate": 0.0005, "new_param": "value"}
        ...
        self.assertEqual(
            self.experiment_manager.config["environment"], "CooperativeNavigation"
        )
    ...
    def test_grid_search(self, mock_run_experiment):
        ...
        param_grid = {"learning_rate": [0.001, 0.0005], "batch_size": [32, 64]}
        ...
        self.assertEqual(
            mock_run_experiment.call_count, 4
        )  # 2x2 parameter combinations
    ...
    def test_get_best_run(self):
        ...
        best_run_reward = self.experiment_manager.get_best_run(
            "reward", higher_is_better=True
        )
        ...
        best_run_success = self.experiment_manager.get_best_run(
            "success_rate", higher_is_better=True
        )
        ...
        worst_run_reward = self.experiment_manager.get_best_run(
            "reward", higher_is_better=False
        )
