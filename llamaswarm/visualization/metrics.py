...
class MetricsPlotter:
    ...
    def plot_training_curve(self, metrics, metric_name, title=None, ylabel=None, 
                           window=None, save_name=None, show=True):
        """
        ...
        if save_name:
            filename = f"{save_name}.png" if not save_name.endswith('.png') else save_name
    ...
    def plot_multi_agent_rewards(self, rewards, agent_names=None, title=None, 
                               window=None, save_name=None, show=True):
        """
    ...
    def plot_loss_components(self, metrics, components, title=None, window=None, 
    ...
    def plot_evaluation_metrics(self, metrics, include_std=True, title=None, 
                              save_name=None, show=True):
        """
    ...
    def plot_agent_comparison(self, metrics_dict, metric_name, agent_names=None, 
                            title=None, save_name=None, show=True, bar=False):
        """
    ...
    def plot_learning_curve_grid(self, metrics_dict, metric_names, titles=None, 
                              agent_names=None, window=None, 
                              save_name=None, show=True):
        """
        ...
        fig, axes = plt.subplots(rows, cols, figsize=(self.figsize[0], rows * 5), sharex=True)
        if n_metrics == 1:
            axes = np.array([axes])
        axes = axes.flatten()
