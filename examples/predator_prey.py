...
from llamaswarm.utils import set_seed, Logger, ExperimentManager
...
def parse_args():
    ...
    parser.add_argument("--num-predators", type=int, default=2, help="Number of predator agents")
    ...
    parser.add_argument("--sensor-range", type=float, default=5.0, help="Agent sensor range")
    parser.add_argument("--prey-speed", type=float, default=1.0, help="Prey movement speed")
    parser.add_argument("--predator-speed", type=float, default=1.2, help="Predator movement speed")
    
    # Training parameters
    parser.add_argument("--num-episodes", type=int, default=3000, help="Number of training episodes")
    ...
    parser.add_argument("--update-freq", type=int, default=100, help="Policy update frequency")
    
    # Output parameters
    parser.add_argument("--exp-name", type=str, default="predator_prey", help="Experiment name")
...
def main():
    ...
    if args.verbose:
        ...
        print("  --grid-search-params prey_speed=0.8,1.0,1.2 predator_speed=1.0,1.2,1.4")
